...
pdf_url_template: https://docs.microsoft.com/pdfstore/ar-sa/VS.core-docs/{branchName}{pdfName}
hideViewSource: false
source_url: https://github.com/MicrosoftDocs/test/blob/master/test/docs/conceptual/azure-cli.md
content_git_url: https://github.com/MicrosoftDocs/test/blob/master/test/docs/conceptual/azure-cli.md
adobe-target: true
---
