                        ...
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                                    <div class="cardImage">
                                        <img data-hoverimage="media/getstarted-developer.png" src="media/getstarted-developer.png" alt="" />
                                    </div>
                                </div>
                                <div class="cardText">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                                    <div class="cardImage">
                                        <img data-hoverimage="media/cloud-adoption-framework.png" src="media/cloud-adoption-framework.png" alt="" />
                                    </div>
                                </div>
                                <div class="cardText">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                <div class="cardImageOuter">
                                    <div class="cardImage">
                                        <img data-hoverimage="media/getstarted_pluralsight.png" src="media/getstarted_pluralsight.png" alt="" />
                                    </div>
                                </div>
                                <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure/python/">
                                                            <img src="media/logo_python.svg" alt="">
                                                            Python</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/java/azure/">
                                                            <img src="media/logo_java.svg" alt="">
                                                            Java</a>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure/app-service-web/app-service-web-get-started-php">
                                                            <img src="media/logo_PHP.svg" alt="">
                                                            PHP</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/azure/javascript/">
                                                            <img src="media/logo_nodejs.svg" alt="">
                                                            Node.js</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/azure/go/">
                                                            <img src="media/logos/logo_Go-lightblue.svg" alt="">
                                                            Go</a>
                                                    </li>
                                                </ul></td></tr></table>
                                               <h4>App Models</h4>
                                                ...
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/cli/azure">
                                                            <img src="media/azure_dev-7.svg" alt="">
                                                            Azure CLI
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/powershell/azure/overview">
                                                            <img src="media/azure_dev-8.svg" alt="">
                                                            Azure PowerShell
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="media/i_mobile-app-developement.svg" alt="">
                                                            Azure mobile app
                                                        </a>
                                                    </li>
                                                </ul>
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure/ansible/">
                                                            <img src="media/ansible.svg" alt="">
                                                            Ansible
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/azure/chef">
                                                            <img src="media/Chef_Regular.svg" alt="">
                                                            Chef
                                                        </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure/terraform">
                                                            <img src="media/logos/logo_terraform.svg" alt="">
                                                            Terraform
                                                        </a>
                                                    </li>
                                                    <li>
                            ...
                            <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/log-analytics/">
                                                <img src="media/OperationsManagementSuite.svg" alt="" />
                                                <p>Log Analytics</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/data-catalog/">
                                                <img src="media/data-catalog.svg" alt="" />
                                                <p>Data Catalog</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/storage/blobs/data-lake-storage-introduction">
                                                <img src="media/Azure-Data-Lake-Store-COLOR.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/data-share/">
                                                <img src="media/data-share.svg" alt="" />
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/blockchain/service/">
                                                <img src="media/blockchain-service.svg" alt="" />
                                                <p>Azure Blockchain Service</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/blockchain/workbench/">
                                                <img src="media/blockchain-workbench-alt.svg" alt="" />
                                                <p>Azure Blockchain Workbench</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/blockchain/tokens/">
                                                <img src="media/blockchain-tokens.svg" alt="" />
                                ...
                                <div class="group">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/virtual-machines/linux/">
                                                <img src="media/VirtualMachine.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/app-service/">
                                                <img src="media/AppService.svg" alt="" />
                                                <p>App Service</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/azure-functions/">
                                                <img src="media/AzureFunctions.svg" alt="" />
                                                <p>Functions</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/batch/">
                                                <img src="media/Batch.svg" alt="" />
                                                <p>Batch</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/container-instances/">
                                                <img src="media/ContainerInstances.svg" alt="" />
                                                <p>Azure Container Instances</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/service-fabric/">
                                                <img src="media/Fabric.svg" alt="" />
                                                <p>Service Fabric</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machine-scale-sets/">
                                                <img src="media/AvailabilitySetOld.svg" alt="" />
                                                <p>Virtual Machine Scale Sets</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/aks/">
                                                <img src="media/containerservice.svg" alt="" />
                                                <p>Azure Kubernetes Service (AKS)</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cloud-services/">
                                                <img src="media/CloudService.svg" alt="" />
                                                <p>Cloud Services</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/cyclecloud/">
                                                <img src="media/logo_cyclecloud.svg" alt="" />
                                                <p>CycleCloud</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/vmware-cloudsimple/">
                                                <img src="media/cs_dedicatedcloudnode.svg" alt="" />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/container-registry/">
                                                <img src="media/container-registry.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/dev-spaces/">
                                                <img src="media/AzureDevSpaceController_50x.svg" alt=""/>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/azure-cache-for-redis/">
                                                <img src="media/RedisCache.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/postgresql/">
                                                <img src="media/PostgreSQL.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/mariadb/">
                                                <img src="media/MariaDB.svg" alt="" />
                                                <p>Azure Database for MariaDB</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/dms/dms-overview">
                                                <img src="media/database-migration.svg" alt="" />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/devops/">
                                                <img src="media/logo_vs-team-services.svg" alt="" />
                                                <p>Azure DevOps</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/sdks">
                                                <img src="media/i_tools.svg" alt="" />
                                                <p>SDKs</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/integrations">
                                                <img src="media/i_extensions.svg" alt="" />
                                                <p>Developer Tool Integrations</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                                <img src="media/i_cligeneric.svg" alt="" />
                                                <p>CLI</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/blockchain-workbench">
                                                <img src="media/blockchain-workbench.svg" alt="" />
                                                <p>Blockchain Workbench</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/azure-app-configuration/">
                                                <img src="media/azure-appconf.svg" alt="" />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/azure-monitor/azure-monitor-app-hub/">
                                                <img src="media/ApplicationInsights.svg" alt="" />
                                                <p>Application Insights</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/lab-services/">
                                                <img src="media/DevTestLabs.svg" alt="" />
                                                <p>Azure Lab Services</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/appcenter/">
                                                <img src="media/logos/logo_vs-mobile-center.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="https://support.hockeyapp.net/kb">
                                                <img src="media/HockeyApp.svg" alt="" />
                                                <p>HockeyApp</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/active-directory/">
                                                <img src="media/ActiveDirectory.svg" alt="" />
                                                <p>Azure Active Directory</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/multi-factor-authentication/">
                                                <img src="media/MultiFactorAuthentication.svg" alt="" />
                                                <p>Multi-Factor Authentication</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/information-protection/">
                                                <img src="media/i_information-protection.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/security/">
                                                <img src="media/SecurityCenter.svg" alt="" />
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/api-management/">
                                                <img src="media/APIManagement.svg" alt="" />
                                                <p>API Management</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/service-bus/">
                                                <img src="media/ServiceBus.svg" alt="" />
                                                <p>Service Bus</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/logic-apps/">
                                                <img src="media/LogicApp.svg" alt="" />
                                                <p>Logic Apps</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/event-grid/">
                                                <img src="media/azure_event_grid.svg" alt="" />
                                                <p>Event Grid</p>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/industry/agriculture/overview-azure-farmbeats">
                                                <img src="media/industry-agriculture-farmbeats.svg" alt="" />
                                                <p>Azure FarmBeats</p>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <li>
                                <div class="group">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/iot-fundamentals">
                                                <img src="media/IoTHub.svg" alt="" />
                                                <p>Azure IoT</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/iot-central/">
                                                <img src="media/iot-central.svg" alt="" />
                                                <p>IoT Central</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/notification-hubs/">
                                                <img src="media/NotificationHubs.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure-sphere/">
                                                <img src="media/azure_sphere.svg" alt="" />
                                                <p>Azure Sphere</p>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/backup/">
                                                <img src="media/Backup.svg" alt="" />
                                                <p>Backup</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/site-recovery/">
                                                <img src="media/SiteRecovery.svg" alt="" />
                                                <p>Site Recovery</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/advisor">
                                                <img src="media/advisor.svg" alt="" />
                                                <p>Azure Advisor</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/scheduler/">
                                                <img src="media/scheduler.svg" alt="" />
                                                <p>Scheduler</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/automation/">
                                                <img src="media/automation.svg" alt="" />
                                                <p>Automation</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/traffic-manager/">
                                                <img src="media/TrafficManager.svg" alt="" />
                                                <p>Traffic Manager</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/monitoring-and-diagnostics/">
                                                <img src="media/AzureMonitoring.svg" alt="" />
                                                <p>Azure Monitor</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/network-watcher/">
                                                <img src="media/network-watcher.svg" alt="" />
                                                <p>Network Watcher</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/service-health">
                                                <img src="media/resource-health.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/azure-resource-manager/">
                                                <img src="media/azure-resource-manager.svg" alt="" />
                                                <p>Azure Resource Manager</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cloud-shell/overview">
                                                <img src="media/cloud-shell.svg" alt="" />
                                                <p>Cloud Shell</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure-stack">
                                                <img src="media/azure-stack.svg" alt="" />
                                                <p>Azure Stack</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/spatial-anchors/">
                                                <img src="media/spatial_anchors.png" alt="" />
                                                <p>Azure Spatial Anchors</p>
                                            </a>
                                        </li>
                                         <li>
                                            <a href="/azure/Kinect-dk/">
                                                <img src="media/kinect-viewer.svg" alt="" />
                                                <p>Azure Kinect DK</p>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/app-service-api/">
                                                <img src="media/app-service-api.svg" alt="" />
                                                <p>API Apps</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="https://azure.microsoft.com/features/xamarin">
                                                <img src="media/logo_xamarin.svg" alt="" />
                                                <p>Xamarin</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/app-service-mobile/">
                                                <img src="media/app-service-mobile.svg" alt="" />
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/networking/networking-overview">
                                                <img src="media/networking-overview.svg" alt="" />
                                                <p>Networking Overview</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cdn/">
                                                <img src="media/ContentDeliveryNetwork.svg" alt="" />
                                                <p>Content Delivery Network</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/expressroute/">
                                                <img src="media/ExpressRoute.svg" alt="" />
                                                <p>ExpressRoute</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/dns/">
                                                <img src="media/DNS.svg" alt="" />
                                                <p>Azure DNS</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-network/">
                                                <img src="media/VirtualNetwork.svg" alt="" />
                                                <p>Virtual Network</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/load-balancer/">
                                                <img src="media/LoadBalancer.svg" alt="" />
                                                <p>Load Balancer</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/vpn-gateway/">
                                                <img src="media/VPNGateway.svg" alt="" />
                                                <p>VPN Gateway</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/application-gateway/">
                                                <img src="media/ApplicationGateway.svg" alt="" />
                                                <p>Application Gateway</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-network/ddos-protection-overview">
                                                <img src="media/ddos.svg" alt="" />
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/key-vault/">
                                                <img src="media/KeyVault.svg" alt="" />
                                                <p>Key Vault</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/dedicated-hsm">
                                                <img src="media/dedicated-hsm.svg" alt="" />
                                                <p>Azure Dedicated HSM</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-network/ddos-protection-overview">
                                                <img src="media/ddos-protection.svg" alt="" />
                                                <p>Azure DDoS protection</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/role-based-access-control/">
                                                <img src="media/PersonWithFriend.svg" alt="" />
                                                <p>Role-based access control</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/sentinel/">
                                                <img src="media/sentinel.png" alt="" />
                                                <p>Azure Sentinel</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/asc-for-iot/">
                                                <img src="media/asc-for-iot.svg" alt="" />
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/azure-government/">
                                                <img src="media/azure-government.svg" alt="" />
                                                <p>Azure US Government</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/germany/">
                                                <img src="media/azure-germany.svg" alt="" />
                                                <p>Azure Germany</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/storage/">
                                                <img src="media/Storage.svg" alt="" />
                                                <p>Storage</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/storsimple/">
                                                <img src="media/StorSimple.svg" alt="" />
                                                <p>StorSimple</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/storage/blobs/storage-blobs-introduction">
                                                <img src="media/logo_azure-blob-storage.svg" alt="" />
                                                <p>Blob Storage</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/windows/managed-disks-overview">
                                                <img src="media/Disks-color.svg" alt="" />
                                                <p>Disk Storage</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/windows/managed-disks-overview">
                                                <img src="media/managed-disks.svg" alt="" />
                                                <p>Managed Disks</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/storage/queues/storage-queues-introduction">
                                                <img src="media/logo_azure-storage-q.svg" alt="" />
                                                <p>Queue Storage</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/storage/files/storage-files-introduction/">
                                                <img src="media/logo_azure-storage-file.svg" alt="" />
                                                <p>File Storage</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/databox-family/">
                                                <img src="media/Service-icon.png" alt="" />
                                                <p>Data Box</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/hpc-cache/">
                                                <img src="media/hpc-cache.svg" alt="" />
                                                <p>Azure HPC Cache</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/avere-vfxt/">
                                                <img src="media/avere.svg" alt="" />
                                                <p>Avere vFXT</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/fxt-edge-filer/">
                                                <img src="media/azure-fxt-edge-filer.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/azure-netapp-files/">
                                                <img src="media/NetAppStorage.svg" alt="" />
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/app-service-web/">
                                                <img src="media/app-service-web.svg" alt="" />
                                        ...
                                        <li>
                                            <a href="/azure/azure-signalr/">
                                                <img src="media/azure-signalr.svg" alt="" />
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/computer-vision/"><img src="media/API_Computer_Vision.svg" alt="" />Computer Vision API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/content-moderator/overview"><img src="media/API_Content_Moderator.svg" alt="" />Content Moderator</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/Custom-Vision-Service/home"><img src="media/API_Custom_Vision.svg" alt="" /><span>Custom Vision Service&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/emotion/home"><img src="media/API_Emotion.svg" alt="" /><span>Emotion API&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/face/"><img src="media/API_Face.svg" alt="" />Face API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/video-indexer/video-indexer-overview"><img src="media/API_VideoIndexer.svg" alt="" /><span>Video Indexer&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/speech/home"><img src="media/API_Bing_Speech.svg" alt="" />Bing Speech API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/custom-speech-service/cognitive-services-custom-speech-home"><img src="media/API_Custom_Speech.svg" alt="" /><span>Custom Speech Service&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/speaker-recognition/home"><img src="media/API_Speaker_Recognition.svg" alt="" /><span>Speaker Recognition API&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="https://docs.microsofttranslator.com/speech-translate.html"><img src="media/API_TranslatorSpeech.svg" alt="" />Translator Speech API</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-spell-check/"><img src="media/API_Bing_Spell_Check.svg" alt="" />Bing Spell Check API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/luis/"><img src="media/API_Luis.svg" alt="" /><span>Language Understanding (LUIS)</span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/linguisticanalysisapi/home"><img src="media/API_LinguisticAnalysis.svg" alt="" /><span>Linguistic Analysis API&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/text-analytics/"><img src="media/API_TextAnalytics.svg" alt="" />Text Analytics API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/translator/translator-info-overview"><img src="media/API_TranslatorText.svg" alt="" />Translator Text API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/web-language-model/home"><img src="media/API_WebLanguageModel.svg" alt="" /><span>Web Language Model API&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/custom-decision-service/custom-decision-service-overview"><img src="media/API_Custom_Decision_Service.svg" alt="" /><span>Custom Decision Service&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/qnamaker/home"><img src="media/API_QnAMaker.svg" alt="" /><span>QnA Maker API&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/recommendations/overview"><img src="media/API_Recommendations.svg" alt="" /><span>Recommendations API&nbsp;<sup style="font-size:70%">PREVIEW</sup></span></a>
                                                            </li>
                                                            <li>
                                            ...
                                            <div class="cardPadding">
                                                <div class="card">
                                                    <div class="cardText">
                                                        ...
                                                        <ul class="noBullet">
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-news-search/search-the-web"><img src="media/API_Bing_News_Search.svg" alt="" />Bing News Search API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/Bing-Video-Search/"><img src="media/API_Bing_Video_Search.svg" alt="" />Bing Video Search API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-web-search/"><img src="media/API_Bing_Web_Search.svg" alt="" />Bing Web Search API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-visual-search/"><img src="media/API_Bing_Visual_Search.svg" alt="" />Bing Visual Search API
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/Bing-Autosuggest"><img src="media/API_Bing_AutoSuggest.svg" alt="" />Bing Autosuggest API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-custom-search"><img src="media/API_Bing_Custom_Search.svg" alt="" />Bing Custom Search API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-entities-search/"><img src="media/API_Bing_Entity_Search.svg" alt="" />Bing Entity Search API</a>
                                                            </li>
                                                            <li>
                                                                <a class="barLink" href="/azure/cognitive-services/bing-image-search"><img src="media/API_Bing_Image_Search.svg" alt="" />Bing Image Search API</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>A simple and safe service for sharing big data with external organizations</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/openshift.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rapid Kubernetes development with containers and microservices</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/CosmosDB_rgb_ui_lighttheme.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Fast, scalable parameter storage for app configuration</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/industry-financial.png" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/industry-health.png" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/industry-manufacturing.png" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Manufacturing</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/industry-retail.png" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Retail</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/question-mark-grey.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                    ...
                    <li>
                        <a href="#mgmt">Management and Governance</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img src="media/media-indexer.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Video Indexer</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Stack</h3>
                                                    <p>Extend Azure services and capabilities on-premises, to build and deploy hybrid cloud and edge applications across cloud boundaries</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Learn how to manage the Azure Stack integrated systems infrastructure and how to offer services</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>A non-production environment for evaluation and testing</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img alt="" src="media/logos/logo_vs-mobile-center.svg">
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Visual Studio App Center</h3>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Highly available and scalable cloud-based network security service</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img alt="" src="media/service-icon-small.png" data-linktype="relative-path">
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img alt="" src="media/hpc-cache.svg" data-linktype="relative-path">
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img alt="" src="media/avere.svg" data-linktype="relative-path">
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                                    <h3>Avere vFXT</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage">
                                                        <img alt="" src="media/azure-fxt-edge-filer.svg" data-linktype="relative-path">
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-1.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-2.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-3.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-4.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-6.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-10.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                                ...
                                                <p>
                                                    <a href="https://www.visualstudio.com/downloads/?utm_medium=microsoft&utm_source=docs.microsoft.com&utm_campaign=button+cta&utm_content=download+vs2017">Download for Visual Studio</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardImageOuter">
                                                <div class="cardImage">
                                                    <img src="media/azure_dev-11.svg" alt="" />
                                                </div>
                                            </div>
                                            <div class="cardText">
                                                <h3>
                                            ...
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage bgdAccent1">
                                                        <img src="media/azure_fundamentals.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage bgdAccent1">
                                                        <img src="media/azure_best-practices.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage bgdAccent1">
                                                        <img src="media/azure_reference-archictectures.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                    <div class="cardImage bgdAccent1">
                                                        <img src="media/azure_patterns.svg" alt="" />
                                                    </div>
                                                </div>
                                                <div class="cardText">
